...
import core.models.ocelot.{labelScalarValue, labelReferences, labelReference}
...
sealed trait ChoiceTest {
  ...
  def value(arg: String, labels: Labels): String = labelScalarValue(arg)(labels).getOrElse("")
