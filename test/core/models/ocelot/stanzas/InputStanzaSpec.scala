...
class InputStanzaSpec extends BaseSpec {
  ...
  "CurrencyInput " should {
    "update the input label" in {
      ...
      updatedLabels.updatedLabels(expectedCurrencyStanza.label).english shouldBe Some(List("33"))
    }
  ...
  "CurrencyPoundsOnlyInput " should {
    "update the input label" in {
      ...
      val labels = LabelCache()
      val (_, updatedLabels) = input.eval("33", labels)
      updatedLabels.updatedLabels(expectedCurrencyPoStanza.label).english shouldBe Some(List("33"))
    }
  ...
  "DateInput" should {
    "update the input label" in {
      ...
      val labels = LabelCache()
      val (_, updatedLabels) = input.eval("33", labels)
      updatedLabels.updatedLabels(expectedDateStanza.label).english shouldBe Some(List("33"))
    }
  ...
  "TextInput" should {
    "update the input label" in {
      ...
      updatedLabels.updatedLabels(expectedTextStanza.label).english shouldBe Some(List("hello"))
    }
  ...
  "NumberInput " should {
    "update the input label" in {
      ...
      newLabels.updatedLabels(expectedNumberStanza.label).english shouldBe Some(List("33"))
    }
