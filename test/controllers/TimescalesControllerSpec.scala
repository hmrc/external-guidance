...
class TimescalesControllerSpec extends WordSpec with Matchers with ScalaFutures with GuiceOneAppPerSuite {
  ...
  //       MockTimescalesService.getById(id).returns(Future.successful(Right(expectedProcess)))
  ...
  //       MockTimescalesService.getById(id).returns(Future.successful(Left(BadRequestError)))
  //       lazy val request: FakeRequest[AnyContentAsEmpty.type] = FakeRequest("GET", "/")
  //     }
  ...
  //       MockTimescalesService.getById(id).returns(Future.successful(Left(NotFoundError)))
  //       lazy val request: FakeRequest[AnyContentAsEmpty.type] = FakeRequest("GET", "/")
  //     }
  ...
  //       val expectedErrorCode = "INTERNAL_SERVER_ERROR"
  //       MockTimescalesService.getById(id).returns(Future.successful(Left(InternalServerError)))
  //       lazy val request: FakeRequest[AnyContentAsEmpty.type] = FakeRequest("GET", "/")
  //     }
